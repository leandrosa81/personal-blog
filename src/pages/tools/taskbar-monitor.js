...
import example5 from "../../../assets/images/taskbar-monitor-animation02.gif";
    ...
    return (
        ...
        <Template>
            <div>
                ...
                <img alt="animation example" src={example5} /><br/>
                ...
                <ul>
                    ...
                    <li>Experimental support for Windows 11 (there are no more official support for "deskbands").</li>
                </ul>
                ...
                <ul>                    
                    <li style={{textDecoration: "line-through"}}>theme selection</li>
                    <li style={{textDecoration: "line-through"}}>support for light theme</li>                    
